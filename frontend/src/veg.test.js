...
describe("Vegeterian Component", () => {
  const mockAddItemToCart = jest.fn();

  test("renders component correctly", () => {
    render(<Vegeterian cart={{}} addItemToCart={mockAddItemToCart} />);

    expect(screen.getByText("Four Cheese - $12.99")).toBeTruthy();  // Alternative check
    expect(screen.getByText("Margherita - $11.99")).toBeTruthy();
    expect(screen.getByText("Veggie Supreme - $13.49")).toBeTruthy();
  });
